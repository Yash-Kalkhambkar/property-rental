...
export function OwnerShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="mesh-owner min-h-screen flex">
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 z-50 glass-owner mx-3 mt-3 rounded-xl px-4 py-3 flex items-center justify-between">
        <BrandLogo variant="owner" linkTo="/dashboard" size="sm" showText={false} />
        <span className="font-semibold text-sm">RentEase</span>
      ...
      <AnimatePresence>
        {mobileOpen && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -10 }}
            className="lg:hidden fixed top-[4.5rem] left-3 right-3 z-40 glass-owner rounded-xl p-4"
          >
      ...
      <main className="relative z-10 flex-1 lg:ml-[4.5rem] pt-20 lg:pt-0 min-h-screen">
